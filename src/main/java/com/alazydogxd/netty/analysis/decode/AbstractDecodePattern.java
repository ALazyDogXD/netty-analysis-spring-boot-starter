...
//
     ...
     * @param in     ByteBuf
     * @param analysis Decode
     * @return 解码结果
     * @throws DecodeFailException          解码失败
     * @throws MessageAnalysisFailException 解析失败
     */
    public abstract Object decode(ChannelHandlerContext ctx, ByteBuf in, Analysis analysis) throws DecodeFailException, MessageAnalysisFailException;
    ...
    public AbstractDecodePattern setConfiguration(MessageAnalysisConfiguration configuration) {
